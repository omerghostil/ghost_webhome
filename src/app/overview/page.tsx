...
import { HomeCopyHe } from "@/components/home-copy-he";
    ...
    <div className="min-h-screen bg-white text-neutral-950 selection:bg-neutral-200">
      ...
      <main>
        ...
        <section className="border-t border-neutral-100 bg-neutral-50/50">
          <div className="max-w-6xl mx-auto px-6 py-24">
            <motion.p
              {...useCasesHeaderMotion}
              transition={{ duration: 0.55, ease: "easeOut" }}
              className="text-[10px] uppercase tracking-[0.2em] text-neutral-400 font-bold mb-4"
            >
              {t("home.sections.useCases.badge")}
            </motion.p>
            <motion.h2
              {...useCasesHeaderMotion}
            ...
            >
              {t("home.sections.useCases.title")}
            </motion.h2>
            <motion.p
              {...useCasesHeaderMotion}
              transition={{ duration: 0.65, ease: "easeOut", delay: 0.16 }}
              className="text-neutral-500 leading-relaxed mb-10 max-w-2xl"
            >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-3">
              {useCases.map((uc, i) => (
                <motion.div
                  ...
                  className="border border-neutral-200 rounded-xl p-5 bg-white hover:border-neutral-300 transition-colors"
                >
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              >
                ...
                <p className="text-sm font-bold text-neutral-300 mb-4">
                  {t("home.sections.product.aiCapabilitiesLabel")}
                </p>
                ...
                <p className="text-white font-bold text-lg max-w-xl">
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="rounded-3xl border border-neutral-800 bg-neutral-900/70 p-6 lg:p-7">
                  <p className="text-[10px] uppercase tracking-[0.16em] text-neutral-500 font-bold mb-4">
                    Ghost Runtime
                  </p>

                  <div className="rounded-2xl border border-neutral-800 bg-neutral-950 p-4 mb-5">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-xs text-neutral-400">מצב ניתוח סצנה</span>
                      <span className="text-[10px] text-emerald-400">ONLINE</span>
                    </div>
                    <p className="text-sm text-neutral-200 leading-relaxed">
                      Ghost מנתח, מחבר הקשר, ומחזיר תשובה תפעולית בשפה טבעית.
                    </p>
                  </div>

                  <div className="relative mb-5 px-2 pt-2 pb-1">
                    <div className="absolute top-6 right-6 left-6 h-px bg-neutral-800" />
                    <motion.div
                      className="absolute top-6 right-6 left-6 h-px bg-white origin-right"
                      animate={{ scaleX: [0, 1] }}
                      transition={{ duration: 1.25, ease: "easeOut", repeat: Infinity, repeatDelay: 0.8 }}
                    />
                    <div className="grid grid-cols-3 gap-3 relative z-10">
                      {[
                        { title: "קליטה", desc: "פריים פעיל מהמצלמה" },
                        { title: "הבנה", desc: "הקשר מלא של הסצנה" },
                        { title: "פעולה", desc: "תשובה/התראה מדויקת" },
                      ].map((item, i) => (
                        <div key={item.title} className="text-center">
                          <motion.div
                            className="w-8 h-8 mx-auto rounded-full border border-neutral-700 bg-neutral-900 flex items-center justify-center mb-2"
                            animate={{ borderColor: ["#404040", "#ffffff", "#404040"] }}
                            transition={{ duration: 2.2, repeat: Infinity, delay: i * 0.25 }}
                          >
                            <span className="text-[10px] font-mono text-neutral-200">{i + 1}</span>
                          </motion.div>
                          <p className="text-[11px] font-bold text-neutral-200">{item.title}</p>
                  ...
                  <div className="rounded-2xl border border-neutral-800 bg-neutral-950 p-4 space-y-2">
                    {[
                      "זוהתה חריגה קלה באזור כניסה ראשית.",
                      "נמצא חפץ שמצמצם מעבר הולכי רגל.",
                      "המלצה: אימות ידני נקודתי ופינוי מיידי.",
                    ].map((line, i) => (
                      <motion.p
                        key={line}
